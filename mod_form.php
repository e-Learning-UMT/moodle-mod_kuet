...
class mod_kuet_mod_form extends moodleform_mod {
    ...
    public function definition(): void {
        ...
        if (isset($this->current) && property_exists($this->current, 'grade')) {
    ...
    public function add_completion_rules(): array {
        ...
        // Get the suffix for form element names (used in bulk completion editing).
        $suffix = $this->get_suffix();
        $elementname = 'completionanswerall' . $suffix;
    ...
    /**
     * Add custom completion rules (for Moodle 5.0+).
     *
     * @return array Array of string IDs of added items, empty array if none
     * @throws coding_exception
     */
    public function add_custom_completion_rules(): array {
        return $this->add_completion_rules();
    }
